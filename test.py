...
parser.add_argument('--decoder_path', type=str, default='models/decoder_iter_160000.pth')
parser.add_argument('--transform_path', type=str, default='models/ma_module_iter_160000.pth')
